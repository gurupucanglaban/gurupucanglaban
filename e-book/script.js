...
<h2>📚 Folder E-Book SD Kelas ${kelas}</h2>
...
<h2>
📚 E-Book SD Kelas ${kelas} - Semester ${semester}
</h2>
...
let daftarMapel = mataPelajaran;

// IPAS dan Bahasa Inggris tidak ditampilkan
// untuk Kelas 1 dan 2
if (kelas === 1 || kelas === 2) {

    daftarMapel = mataPelajaran.filter(function (mapel) {
...
<a href="ebook/kelas${kelas}/semester${semester}/${mapel}.pdf"
